  ...
  return (
    <>
      <div className='h-screen w-screen bg-slate-600 flex flex-col justify-center items-center'>
        <h1 className='text-3xl text-white bg-slate-950 p-5 rounded-t-lg text-center w-1/3'>Password Generator</h1>
        <div className='h-1/3 w-1/3 bg-slate-300 rounded-b-lg flex flex-col justify-center items-center px-10'>
